                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="" method="post" id="device_settings" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Device Id <i class="fa fa-asterisk" style="font-size:8px;color:red;"></i></label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="dev_id" id="dev_id" placeholder="Enter Device Id" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-sm-3 col-form-label">Device Name <i class="fa fa-asterisk" style="font-size:8px;color:red;"></i></label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="dev_name" id="dev_name" placeholder="Enter Device Name" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Device Location <i class="fa fa-asterisk" style="font-size:8px;color:red;"></i></label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="dev_loc" id="dev_loc" placeholder="Enter Device Location" required>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="form-group row">
